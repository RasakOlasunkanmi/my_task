...
"""
This code collects candidate information and checks eligibility for a scholarship
...
subjects_input = input("Subjects (comma-separated): ").title()
subjects = [s.strip().title() for s in subjects_input.split(",")][:5]
print(subjects)
...
has_required_subjects = "Englishgit " in subjects and "Mathematics" in subjects
print(has_required_subjects)
...
print("\nEnter the names of up to five WAEC/WASSCE subjects in which you received a distinction (A or B), separated by commas.")
